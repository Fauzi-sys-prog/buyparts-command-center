...
See [docs/architecture.md](docs/architecture.md), [docs/mvp-roadmap.md](docs/mvp-roadmap.md), [docs/shopify-ingestion.md](docs/shopify-ingestion.md), [docs/stack-alignment.md](docs/stack-alignment.md), [docs/manual-setup-checklist.md](docs/manual-setup-checklist.md), [docs/bigquery-warehouse-plan.md](docs/bigquery-warehouse-plan.md), and [docs/growth-channels-plan.md](docs/growth-channels-plan.md) for the planning layer behind this scaffold.
